...
export const scenario1: ScenarioData = {
  ...
  auditEntries: {
    ...
    awaiting_approval: { actor: 'Orchestration', action: 'Approval Gate', detail: 'Awaiting CISO.', phase: 'awaiting_approval' },
...
export const scenario4: ScenarioData = {
  ...
  auditEntries: {
    ...
    awaiting_approval: { actor: 'Orchestration', action: 'Approval Gate', detail: 'Awaiting CISO & DPO.', phase: 'awaiting_approval' },
